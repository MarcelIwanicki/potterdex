...
class HarryPotterCharactersService {
  final LocalHarryPotterCharactersDatabase localDatabase;
  ...
  Future<void> addHarryPotterCharacterToLocalRepository(
    ...
    await localDatabase.dao.addHarryPotterCharacter(harryPotterCharacter);
  }

  Future<List<HarryPotterCharacter>>
  getHarryPotterCharactersFromLocalDatabase() async {
    return await localDatabase.dao.getAllHarryPotterCharacters();
  }
}
